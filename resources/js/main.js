...
function buildNextCard() {
  ...
  back.innerHTML = `<p>${prompts[current].answer}</p><p><a href="${prompts[current].link}" target="_blank">reference</a></p><p><a href="${prompts[current - 2].link}" target="_blank">reference</a></p>`;
