...
function buildNextCard() {
  ...
  back.innerHTML = `<p>${prompts[current].answer}</p><img src="${prompts[current].image}" alt="Image"><p><a href="${prompts[current].link}" target="_blank">reference</a></p><p><a href="${prompts[current - 2].link}" target="_blank">reference</a></p>`;
...
function buildPrevCard() {
  ...
  back.innerHTML = `<p>${prompts[current - 2].answer}</p><img src="${prompts[current - 2].image}" alt="Image"><p><a href="${prompts[current - 2].link}" target="_blank">reference</a></p>`;
  count.innerHTML = `<p>${current - 1} / ${prompts.length}</p>`;
  current--;
}
